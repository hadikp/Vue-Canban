...
import {faCog, faIgloo, faPlus, faUserAstronaut, faDownload, faUpload, faPencil, faPrint, faThumbTack, faImage, 
  ...
  faFontAwesomeFlag, faFilter, faRotate, faCaretDown, faHandshake, faEdit, faMagicWandSparkles, faChevronRight} from '@fortawesome/free-solid-svg-icons'
...
library.add(faCog, faIgloo, faPlus, faUserAstronaut, faDownload, faUpload, faPencil, faPrint, faThumbTack, faImage,
  ...
  faLineChart, faFontAwesomeFlag, faFilter, faRotate, faCaretDown, faHandshake, faEdit, faMagicWandSparkles, faChevronRight)
